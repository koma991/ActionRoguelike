...
void ALExplodingBarrel::OnHit(UPrimitiveComponent* HitComponent, /* ��ײ��������� */ AActor* OtherActor, /* ������ײ����һ�� Actor */ UPrimitiveComponent* OtherComp, /* ��һ����� */ FVector NormalImpulse, /* ���߷����ϵĳ���� */ const FHitResult& Hit)
{
